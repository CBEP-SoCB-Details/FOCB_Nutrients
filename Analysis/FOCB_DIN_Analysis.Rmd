...
Accordingly, here we restrict our analysis to looking at DIN. a Sparate notebook looks at TN. 
...
the unbalanced sampling history biasing estimates for the entire year.
...
warmer months of hte year, when seasonal variation is smaller.
...
```
Again, qualitatively similar results, but this models appears to slightly 
...
There appears to be little advantage to robust models.  Even so, there are several approaches possible:  
